---@class yi.incremental_selection.nodes.Entry
---@field tick integer
---@field nodes TSNode[]

---@class yi.incremental_selection.Nodes
---@field private entries table<integer, yi.incremental_selection.nodes.Entry>
local Nodes = {}
Nodes.__index = Nodes

---@return yi.incremental_selection.Nodes
function Nodes.new()
